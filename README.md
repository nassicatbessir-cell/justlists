...
| `baseURL` | `string \| null` | `process.env["DEFAULT_TEAM_4_HOHQ_BASE_URL"]` | Override the default API base URL. Pass `null` when selecting a configured environment. |
...
| `logLevel` | `"off" \| "error" \| "warn" \| "info" \| "debug" \| null` | `process.env["DEFAULT_TEAM_4_HOHQ_LOG"]` | Controls request and retry debug logging. |
